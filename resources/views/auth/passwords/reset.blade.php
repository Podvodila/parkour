            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.request') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('reset.Password') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('reset.Confirm Password') }}</label>
